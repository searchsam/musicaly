...
\markup {
  \left-column {
    \null
    \line {"44. " \small \with-color #red "Este prefacio se dice durante el tiempo pascual."}
    \null
    \line {\small \with-color #red "En la misa de la Vigilia pascual se dice " "en esta noche" \small \with-color #red ";	el día de Pascua y durante la octava: " "en este día" \small \with-color #red ";	en las"}
    \line {\small \with-color #red "restantes misas: " "en este tiempo" \small \with-color #red "."}
    \null
  }
}
...
\markup {
  ...
  \fill-line {
    \center-column {
      ...
      \null
      \null
      \fontsize #2 \caps "El misterio Pascual"
      \null
    }
  }
}
