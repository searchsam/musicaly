...
\markup { 
  \fill-line {
    \center-column {
      ...
      \null
      \null
      \fontsize #4 "PREFACIO DEL MATRIMONIO"
      \null
...
\markup {
  \left-column {
    \null
    \line {"66. " \small \with-color #red "Este prefacio se dice en la misa del mattrimonio."}
    \null
  }
}
...
\markup {
  ...
  \fill-line {
    \center-column {
      ...
      \null
      \null
      \fontsize #2 \caps "La dignidad de la alianza nupcial"
      \null
    }
  }
}
