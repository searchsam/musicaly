  ...
  <<
    {
      ...
      sol1 | \break
      r2 r8 sol sol la |
      <sol sib>2 do8 sib la8 sib |
      <sol do>2 sib8 la sib do |
      <sol do>4. re'4 do8 sib la | \break
      sol2 r8 sol sol la |
      <sol sib>2 do8 sib la8 sib |
      <sol do>2 re'8 mib re8 do |
      <sol sib>4 do8 sib8 <fa la>4 sol8 fa |
      sol1 | \break
      fa'8 mib re4 sib2 |
      la4 fa2 sol8 la |
      sib4 do8 sib la4 sol8 fa |
    ...
    }
    {
      ...
      <sib mib>16 fa' <sib, mib> re <sol, sib> do <sol sib> la <la do>16 re <la do> sib <la do> <sib re> <do mib> <sib fa'> |
      <re sol>1 |
      <re, sol>1 |
      <do fa>1 |
      <sib mib>2 <do fa> | %9
