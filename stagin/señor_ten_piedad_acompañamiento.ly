...
NotesSop = \relative do' { 
    ...
    do,2 re  | fa2 sol2~ | sol1~ | sol1~ | sol1 | \tuplet 3/2 { la2 sol fa }  | re1 | la'1~ | la2 sol | la2 re, | la'4 fa2 fa4 | sol4 la2. |
}
...
NotesTer = \relative do { 
    ...
    mi2 fa  | la2 sib2~ | sib1~ | sib1~ | sib1  | \tuplet 3/2 { do2 dos la } | fa1 | fa1~  | fa2 mi  | fa1~    | fa1~  | fa1 |
}
NotesBas = \relative do { 
    ...
    do2 re  | re2 sol2~ | sol1~ | sol1~ | sol1 | \tuplet 3/2 { fa2 la fa }  | re1 | re1~  | re2 do  | re1~    | re1~  | re1 |
}
...
armonias = \new ChordNames { 
    \chordmode { 
        ...
        do2 re2:m | R1 | sol1:m | R1 | R1 | \tuplet 3/2 { fa2 la2:7 fa2 } | re1:m | R1 | R2 do2 | re1:m
    }
}
