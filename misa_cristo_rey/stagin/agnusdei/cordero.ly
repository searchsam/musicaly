...
<<
    \new Voice = "invocacion" {
        ...
        \key re \minor
        \relative do' {
            la^\markup{ \italic "Solo"} la la do re re re re re re re do re mi re
        }
    }
...
<<
    \new Voice = "invocacion" {
        ...
        \key re \minor
        \relative do' {
            la4^\markup{ \italic "Solo"} la la la la do re re re re re re re re do re mi re
        }
    }
    \new Lyrics \lyricsto "invocacion" {
        \lyricmode {
...
<<
    \new Voice = "invocacion" {
        ...
        \key re \minor
        \relative do' {
            la4^\markup{ \italic "Solo"} la la la la la do re re re re re re do re mi re
        }
    }
    \new Lyrics \lyricsto "invocacion" {
        \lyricmode {
