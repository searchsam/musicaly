...
% --- Cabecera
\markup { \fill-line { \center-column { \fontsize #5 \smallCaps "Aleluya" \fontsize #2 "Misa de Cristo Rey" "Aleluya - Solemnidad Cristo Rey" } } }
...
soprano_music = \relative do' {
  ...
  r4 re'\p^\markup{ \italic \small "Todos" } dos si	|
  la4 re dos si 		|
...
alto_music = \relative do' {
  R1*2		|
  r2 r4 r8 la8^\markup{ \italic \small "Todos" } 	| \bar "||" \break
