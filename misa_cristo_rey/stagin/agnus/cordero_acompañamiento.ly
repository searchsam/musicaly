...
\markup { \fill-line { " " "Agnus Dei" \center-column { \fontsize #2 "Samuel Gutiérrez" \small "(2018)" } } }
\header {
...
altMusic = \relative do' {
  R1*5 |
  sol'4^\markup{ \italic "Solo Mezzo"} sol sol sol( |
  la4) la2. |
  
  R1*2 |
  re,1^\markup{ \italic "Todos"} |
  sib1 |
  do1 |
  fa2 la, |
  fa'2 sib,~ |
  ...
  R1*2
  sol4^\markup{ \italic "Solo Mezzo"} sol sol sol( |
  la4) la2. |
  R1*2 |
...
armonias = \new ChordNames {
  \chordmode {
    ...
    R1*2 | do1 | fa1 | sib1 | R1 | sol1:m | la1 | re1:m | sol1:m | sib1 | la1:7 | re1 |
    
    re1:7 | sol1:m | R1 | la1 | la1:7 | re1:m |
    R1*2 | do1 | fa1 | sib1 | R1 | sol1:m | la1 | re1:m | sol1:m | sib1 | la1:7 | re1 |
    
    re1:7 | sol1:m | R1 | la1 | la1:7 | re1:m |
    R1*2 | do1 | fa1 | sib1 | R1 | sol1:m | la1 | re1:m | do2:7 la2:m | re1:m | mi1:m7 | la1:m |
  }
}
