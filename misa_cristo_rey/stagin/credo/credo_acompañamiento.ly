...
% --- Cabecera
\markup { \fill-line { \center-column { \fontsize #5 \smallCaps "Creo en Dios" \fontsize #2 "Misa Cristo Rey" } } }
\markup { \fill-line { " " "Credo" \center-column { \fontsize #2 "Samuel Gutiérrez" \small "(Octubre 2019)" } } }
\header {
...
armonias = \new ChordNames {
  \chordmode {
    \italianChords
    R1*4 | sib1 | fa1:7 | sib1 |
    
    R1 | mib2 re2:m | do2.:m sib4 | R1 | do1:7 | fa1 |
    R1 | sol1:m | re2:m sol2:7 | do2 fa2 | R2 do2 | sol1:m | fa2 sol2 | R4 la2. | 
    
    sib1 | fa1:7 | sib1 |
    R1 | mib2 re2:m | do2.:m sib4 | R1 | do1:7 | fa1 |
    R1 | sol1:m | re2:m sol2:7 | do2 fa2 | R2 do2 | R4 sol2:m fa4 | sol1:m | fa2. sol4:m | R4 re2:7 sol4:m | R4 fa2. | sol2 fa2 | sol1 | la1 | sib1 |
    
    do2:m sib2 | do2:m sib2 | do1:m | R1 | sib2. do4:m | R4 sib2. |
    do2:m sib2 | do2:m sib2 | do1:m | R1 | sib2. do4:m | R4 sib2. |
    fa1 | do2:m sib2 | R2 do2:m | sib1 |
    sol1:m | fa2 | R8 sol4.:m | fa2 | R8 sol4.:m | fa4. sol8:m | R4 fa4 | R4. sol8:m | R8 sib8 re4:m | do8:m re4.:m |
    sib2 | R4 do4:m | R8 fa4. | R2 | sol2:m | sib2 | R4 do4:m | R8 fa4. | R8 sol4:m fa8 | R4 sol4:m | fa2 | sol2:m |
    sol2:m | re2:m | R4 sol4:m | fa2 | sol2:m | R4. fa8 | sib4. fa8 | sib2 | 
    
    sib1 | fa1:7 | sib1 |
    R1 | mib2 re2:m | do2.:m sib4 | R1 | do1:7 | fa1 |
    R1 | sol1:m | re2:m sol2:7 | do2 sol2:m | fa2 do2 | sol2:m re2 | sol2:m sib2 | R2 fa2 | R4 sol2:m do4 | R4 fa2 sib4 | R1 | fa2 do2 | sol2.:m re4:m | R4 sol2. | la1 |
