% El señor resucito aleluya - Tenor
% by serachsam
...
\markup { \fill-line { \fontsize #2 \voice \right-column { \fontsize #2 \autor } } }
  ...
  <<
    \new Staff {
      <<
        ...
        \new Voice = \voice { << \global \tenor >> }
        \new Lyrics \lyricsto \voice { \tenor-lyrics }
      >>
    }
    %\metronome
  >>
