%%% book-titling.ily  -- una hoja de estilo de titulacion para su uso en los libros
%%% 
...
%% saltar espacio vertical
#(define-markup-command (vspace layout props amount) (number?)
  "Esto produce un objeto invisible teniendo espacio vertical."
...
%%% Guile no se ocupa de las letras acentuadas
#(use-modules (ice-9 regex))
%%;; en realidad se define a continuaciÃƒÂ³n, en un cierre
#(define-public string-upper-case #f)
#(define accented-char-upper-case? #f)
#(define accented-char-lower-case? #f)

%%;; un carÃƒÂ¡cter acentuado se ve como dos personajes por engaÃƒÂ±o
#(let ((lower-case-accented-string "ÃƒÂ©ÃƒÂ¨ÃƒÂªÃƒÂ«ÃƒÂ¡ÃƒÂ ÃƒÂ¢ÃƒÂ¤ÃƒÂ­ÃƒÂ¬ÃƒÂ®ÃƒÂ¯ÃƒÂ³ÃƒÂ²ÃƒÂ´ÃƒÂ¶ÃƒÂºÃƒÂ¹ÃƒÂ»ÃƒÂ¼ÃƒÂ§Ã…â€œÃƒÂ¦")
       (upper-case-accented-string "Ãƒâ€°ÃƒË†ÃƒÅ Ãƒâ€¹Ãƒï¿½Ãƒâ‚¬Ãƒâ€šÃƒâ€žÃƒï¿½ÃƒÅ’ÃƒÅ½Ãƒï¿½Ãƒâ€œÃƒâ€™Ãƒâ€�Ãƒâ€“ÃƒÅ¡Ãƒâ„¢Ãƒâ€ºÃƒÅ“Ãƒâ€¡Ã…â€™Ãƒâ€ "))
...
#(define-markup-command (smallCaps layout props text) (markup?)
  "Gire @code{texto}, que debe ser una cadena, con minÃƒÂºsculas.
@ejemplo
\\markup \\small-caps \"Texto entre comillas dobles\"
@y ejemplo"
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Marcado de comandos para los encabezados de pÃƒÂ¡gina
%%%
...
%% Pagina 1.
  ...
  \header {
  	  title = \markup { \caps "Metodo del Canto Aleman" }
  	  composer = \markup { \larger "Daniel Garcia" }
  	  poet = "Canto y Tecnical Vocal"
  	  date = "MULTIMEDIA"
  	  arrangement = "..."
  ...
  \paper {
   ...
   \markup {
   	   \fill-line {
   	   	   \center-column { \huge \larger "Prologo" }
   	   }
   }
   \markup { \null }
   \markup { 
   	   \large
   	   \justify {
   	   	   Esta es la ultima actividad del tipo Hagalo usted mismo.
   	   	   Nadie puede hacerla por ti y nadie podra hacerte sentir tan bien cuando recuerdes,
   	   	   con una sonrisa, los dias de desanimo cuendo todo te salia mal, o no te salia.
   	   	   Cantar es una actividad y, si encuentras como hacerla, tambien encontraras la voz de tus sueños.
   	   }
   }
   \markup { \null }
   \markup { 
