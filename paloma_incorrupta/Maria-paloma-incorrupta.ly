...
oboe = \relative c' { 	
	...
	r4 r16 d,16 e16 f16 | %14
	e8 d8 cis8 d8 e8 d8 bes8 a8 g2( |%15
	...
	\textLengthOff
	f,4 \times 2/3 { g8 a8 bes8 } \times 2/3 { a8 g8 f8 } bes4~ | %32
	bes4 f4 bes2 | %33
	\textLengthOn
	s1_\markup { 
		\center-column { 
	...
	d4. e4. cis8 \times 2/3 { bes16 cis16 bes16 } | %48
	a2. r4 | %49
	\bar "||"
	\textLengthOn
	s1_\markup { 
	...
	d4. e4. cis8 \times 2/3 { bes16 cis16 bes16 } | %71
	a2. r4 | %72
	\bar "||"
	\textLengthOn
...
armonias = \new ChordNames {
  ...
  \chordmode { 
  	R1*6
	d1:m R1 g1:m R1 a1 R1 d1:m R1 R2 g1:m R2 a1 R1*3 d1:m
