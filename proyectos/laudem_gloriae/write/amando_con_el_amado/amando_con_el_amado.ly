% *****************************************************************************
% Amando con el amado - Dedicated to the Poor Clare sisters of the
...
% --- Header
\markup { \fill-line { \center-column { \fontsize #5 \smallCaps "Amando con el amado" \fontsize #3 "De las cartas de Clara de Asis a Inés de Praga" } } }
\markup { \fill-line { " " \right-column { \fontsize #2 "Letra: Clara de Asis, O.S.C." } } }
\markup { \fill-line { " " \right-column { \fontsize #2 "Musica: Linda Martínez" } } }
\markup { \fill-line { " " \right-column { \fontsize #2 "Samuel Gutiérrez" } } }

\header {
  dedication = "Dedicado a Jasser Josue O.F.S."
