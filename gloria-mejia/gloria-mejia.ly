...
\markup { \fill-line { \center-column { \fontsize #5 "Gloria" \fontsize #2 "" \small "Para la Gloria del Señor" } } }
\markup { \fill-line { " " \fontsize #2 "Alejandro Mejia"  } }
\markup { \fill-line { " " \fontsize #2 "Armonizacion: Francisco Jarquín Vega"  } }
\header {
