...
% --- Cabecera
\markup { \fill-line { \center-column { \fontsize #5 \smallCaps "Anhelo de una alma" \fontsize #2 "Escritos de San Rafael Arnáiz Barón O.C.S.O." } } }
\markup { \fill-line { \fontsize #2 \smallCaps "Coro Femenino" \fontsize #2 "Música: Samuel Gutiérrez"  } }
...
sopMusic = \relative do'' {
    R2*2
    r4 r8 sol fas4 mi8 re mi4 mi~ mi r
    R2*3
    si'8 si si8 si la la sol la si4 si~ si r
    R2*2
    r4 r8 sol8 fas mi mi re mi2
    R2*4
    si'4 si8 si la4 sol8( la) si4 si~ si r
    la4. la8 la la8 fas8 la8 si2
    
    r4 r8 sols sols4. sols8 la4. la8 sols2
    R2 
    do8 do do4 do8 do la do si4 si4~ si r
    do4 do8 do do8 do do4 la8 do si4~ si r8 si8 
    la la8 la4 si8 si4 si16 si16 la8 la la8 la si2
    R2
...
altMusic = \relative do' {
    mi4 mi8 mi sol4 sol8 sol mi2
    R2*3
    mi4 mi8 mi fas4 fas8 fas sol2
    R2*4
    mi4. mi8 sol4 sol8 sol8 mi2
    R2*3
    mi2 fas4 fas8 fas sol2
    R2*4
    ...
    mi4 mi8 mi mi mi mi4 do8 mi sols4~ sols r8 mi
    re re8 re4 re8 re4 re16 re16 fas8 fas fas8 fas sols2
    R2
    sol8 sol sol sol sol sol4 sol8 mi4. r8 mi8 mi re re mi2
    
    R2
    mi4 mi8 mi sol4. sol8 mi4 mi
    R2*3
    mi4. mi8 fas fas fas8 fas sol8 sol4.
    R2*4
    mi2( sol4) sol8 sol8 mi4 mi
    R2*3
    mi2 fas2 sol2
    R2*4
    fas4. fas8 fas fas8 re8 fas8 mi2
