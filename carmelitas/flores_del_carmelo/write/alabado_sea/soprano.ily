soprano_music = \relative do' {
  ...
  r4^\markup { \italic "Solo" } r8 mi |
  re8 mi la do |
  si4 la8 sol |
  la4 la |
  la4^\markup { \italic "Todos" } si8 do |
  si4 la8 sol |
  la4 r8^\markup { \italic "Solo" } mi | #(if (= particle 1) jump "")
  re8 mi la( do) |
  si4 la8 sol |
  la4 la |
  la4^\markup { \italic "Todos" } si8 do |
  ...
  la4^\markup { \italic "Todos" } si8 do |
  si4 la8 sol |
  la4 r^\markup { \italic "Solo" } | #(if (= particle 1) jump "")
  mi4 la8 do |
  si4 la8 sol |
  la4 la |
  la4^\markup { \italic "Todos" } si8 do |
