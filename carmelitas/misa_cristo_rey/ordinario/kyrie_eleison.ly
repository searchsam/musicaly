...
cantusLyricsAlternate = \lyricmode {
...
altusLyricsAlternate = \lyricmode {
  ...
  <<
    \new StaffGroup = choirStaff <<
      \new Voice = "cantusNotes" <<
        ...
        \cantusNotes
      >>
      \new Lyrics \lyricsto cantusNotes { \cantusLyricsAlternate }
      \new Voice = "altusNotes" <<
        \set Staff.instrumentName = #"Altus"
        \global
        \incipit \altusIncipit
        \altusNotes
      >>
      \new Lyrics \lyricsto altusNotes { \altusLyricsAlternate }
    >>
  >>
  \layout {
    \context {
