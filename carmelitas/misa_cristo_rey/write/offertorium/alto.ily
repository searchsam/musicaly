alto_music = \relative do' {
  ...
  re4 fa sol2 |
  fa8 mib re do re mib fa re |
  mi4 mi re2 | #(if (= particle 1) jump "") % 37
  re8 re re4 do8( sib) la( do) |
  re2 sib |
  do8 re mib fa do re mib do |
  re4 do re2~ |
  ...
  re4 fa sol2 |
  fa8 mib re do re mib fa re |
  mi4 mi re2 | #(if (= particle 1) jump "") % 69
  re4 re8 re do8 sib la do |
  re2 sib |
  do8( re) mib fa do( re) mib do |
  re4( do) re2~ |
