soprano_music = \relative do'' {
  ...
  R1 |
  sib4^\markup{ \italic "Solo"} sib( la2) |
  R1*2 | #(if (= particle 1) jump "") % 4
  sib4^\markup{ \italic "Todos"}( la8 sib do4) sib |
  sib4( la8 sib do4) sib |
  sib4( la8 sib do4) sib \breathe | #(if (= particle 1) jump "") % 7
  sol4 la sib do |
  sib la sib r |
  sol4 la sib do |
  sib la sib do( |
  ...
  sib4( la8 sib do4) sib |
  sib4( la8 sib do4) sib |
  sib4( la8 sib do4) sib \breathe | #(if (= particle 1) jump "") % 23
  sol4 la sib do |
  sib la sib r |
  sol4 la sib do |
  sib la( sib) do( |
