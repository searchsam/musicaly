...
% --- Header
\markup { \fill-line { \center-column { \fontsize #5 \caps \title \fontsize #2 \smallCaps \subtitle \fontsize #1 \subsubtitle } } }
...
\markup {
  \bold "*" "Si el" \italic "Sacerdote" "no realiza el" \bold "Solo" "lo realizaria una" \italic "Soprano" "una octava más alta."
}
