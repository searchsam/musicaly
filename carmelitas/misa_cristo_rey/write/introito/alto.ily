alto_music = \relative do' {
  ...
  do8 re mi do re4 re |
  do4 re8( mi) sib4 sib |
  mi8 re  do re mi4 mi \breathe | #(if (= particle 1) jump "") % 8
  la,4 re8 mi re4 re4 |
  mi8 fa sol mi re4 re |
  do4 re8( mi) fa4 fa |
  sol8 fa mi fa mi2 |
  re1 | \bar "||" #(if (= particle 1) jump "") % 13
  R1*9 | \bar "||" #(if (= particle 1) jump "") % 22
  la4 re8( mi) fa4 re8 re |
  do8 re mi do re4 re |
  do4 re8 mi sib4 sib |
  mi8 re  do re mi4 mi \breathe | \bar "||" #(if (= particle 1) jump "") % 26
  la,4 re8 mi re4 re8 re |
  mi8 fa sol mi re4 re |
  do4 re8 mi fa4 fa |
  sol8 fa mi fa mi2 |
  re1 | \bar "||" #(if (= particle 1) jump "") % 31
  R1*9 | \bar "||" #(if (= particle 1) jump "") % 40
  la4 re8 mi fa4 re4 |
  do8( re) mi do re4 re |
  do4 re8 mi sib4 sib8 sib |
  mi8 re  do re mi4 mi \breathe | #(if (= particle 1) jump "") % 44
  la,4 re8 mi re4 re |
  mi8 fa sol mi re4 re |
  do4 re8 mi fa4 fa |
  sol8 fa mi fa mi2 |
  re1 | \bar "||" #(if (= particle 1) jump "") % 49
  R1*9 | \bar "||" #(if (= particle 1) jump "") % 58
  la4 re8( mi) fa4 re4 |
  do8 re mi do re4 re |
  do4 re8 mi sib4 sib |
  mi8 re  do re mi4 mi \breathe | #(if (= particle 1) jump "") % 62
  la,4 re8 mi re4 re |
  mi8 fa sol mi re4 re |
  do4 re8 mi fa4 fa |
  sol8( fa) mi fa mi2 |
  re1 | \bar "||" #(if (= particle 1) jump "") % 67
  R1*9 | \bar "||" #(if (= particle 1) jump "") % 76
  do1 |
  re1 |
