...
Music = \relative do' {
  ...
  fa8^\markup{ "Estrofa I" \italic "Solo Mezzosoprano" } sol la la la la la la \breathe |
  ...
  fa8^\markup{ "Estrofa II" \italic "Solo Mezzosoprano" } sol la la la la la la \breathe |
  ...
  fa8^\markup{ "Estrofa III" \italic "Solo Mezzosoprano" } sol la la la la la4\breathe |
  \tuplet 3/2 {la8( fa) sol} la4 la r | \break
